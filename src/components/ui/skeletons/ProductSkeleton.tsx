...
export default function ProductSkeleton(): JSX.Element {
    ...
    return (
        ...
        <div className='w-[20%] min-w-[200px] h-[300px] max-w-[230px  rounded-lg overflow-hidden relative skeleton' >

            <div className='flex flex-col bg-gray-100 absolute text-sm bottom-0 left-0 h-[35%] w-full p-2 pt-5 '>
                <div className="flex flex-col gap-2 mb-5">
                    <div className="w-[50%] h-[7px] rounded-full skeleton-2"></div>
                    <div className="w-[100%] h-[5px] rounded-full skeleton-2"></div>
                    <div className="w-[100%] h-[5px] rounded-full skeleton-2"></div>
                </div>

                <div className='flex justify-between items-center'>
                    <svg className='fill-gray-300' width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="w-[20%] h-[5px] rounded-full skeleton-2"></div>
                </div>
            </div>
        </div>
    )
