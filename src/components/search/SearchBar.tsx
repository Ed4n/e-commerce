...
export default function SearchBar({ }: Props) {
    ...
    return (
        <div className={(searchOpen ? 'top-20 bg-white/80 shadow-lg w-[90%] ' : ' w-[60%] search-glass bottom-10 shadow-2xl')
            + ' fixed z-20 left-0   right-0 m-auto  max-w-[800px] h-[70px]  rounded-full px-5 py-2 flex items-center gap-2 transition-all duration-300 outline-none placeholder:text-black/60 text-xl  '}>

            {/* Searchbar Icon */}
            {!searchOpen ? (<svg width="20" className=' fill-black/30' height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
